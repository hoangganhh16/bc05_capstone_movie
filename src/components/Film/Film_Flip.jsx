    ...
    <div className="flip-card mt-3">
      <div className="flip-card-inner">
        <div className="flip-card-front">
          <img src={item.hinhAnh} alt="Avatar" className="w-full h-full" />
        </div>
        <div
      ...
      <div
        ...
        className="bg-orange-300 text-center cursor-pointer pb-2 bg-indigo-300 my-2 text-success-200 font-bold"
      >
        ĐẶT VÉ
      </div>
    </div>
